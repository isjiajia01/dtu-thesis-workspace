...
#BSUB -J SCENARIO1_RobustV4EventCommit[1-10]
#BSUB -q hpc
#BSUB -o logs/scenario1_robust_v4_event_commitment_%I.out
#BSUB -e logs/scenario1_robust_v4_event_commitment_%I.err
#BSUB -n 1
#BSUB -W 01:00
...
OVERRIDES=(
  --override "endpoint_key=scenario1_robust_v4_event_commitment"
