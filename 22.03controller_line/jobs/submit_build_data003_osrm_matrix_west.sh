...
#BSUB -J BUILD_DATA003_OSRM_WEST
#BSUB -q hpc
#BSUB -o logs/build_data003_osrm_matrix_west.out
#BSUB -e logs/build_data003_osrm_matrix_west.err
#BSUB -n 1
#BSUB -W 08:00
...
BENCHMARK_PATH="${BENCHMARK_PATH:-data/processed/multiday_benchmark_west.json}"
OUTPUT_DIR="${OUTPUT_DIR:-data/processed/vrp_matrix_west}"
