...
# Herlev v6g_v6d compute300 rolled back mainline to cap05.

#BSUB -J SCENARIO1_RobustV6GReserve_V6D_T300[1-10]
#BSUB -q hpc
#BSUB -o logs/scenario1_robust_v6g_deadline_reservation_v6d_compute300_%I.out
#BSUB -e logs/scenario1_robust_v6g_deadline_reservation_v6d_compute300_%I.err
#BSUB -n 1
#BSUB -W 06:00
