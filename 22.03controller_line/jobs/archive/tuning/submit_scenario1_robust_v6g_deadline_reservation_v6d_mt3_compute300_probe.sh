...
#BSUB -J SCENARIO1_RobustV6GReserve_V6D_MT3_T300[1-10]
#BSUB -q hpc
#BSUB -o logs/scenario1_robust_v6g_deadline_reservation_v6d_mt3_compute300_probe_%I.out
#BSUB -e logs/scenario1_robust_v6g_deadline_reservation_v6d_mt3_compute300_probe_%I.err
#BSUB -n 1
#BSUB -W 04:00
...
OVERRIDES=(
  --override "endpoint_key=scenario1_robust_v6g_deadline_reservation_v6d_mt3_compute300_probe"
