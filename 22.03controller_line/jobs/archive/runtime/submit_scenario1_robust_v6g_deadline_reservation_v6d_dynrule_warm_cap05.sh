...
# Herlev Scenario1 v6g cap05 dynamic-time experiment.
...
#BSUB -J SC1_V6G_CAP05_DYNWARM[1-10]
#BSUB -q hpc
#BSUB -o logs/scenario1_robust_v6g_deadline_reservation_v6d_dynrule_warm_cap05_%I.out
#BSUB -e logs/scenario1_robust_v6g_deadline_reservation_v6d_dynrule_warm_cap05_%I.err
#BSUB -n 1
#BSUB -W 06:00
...
OVERRIDES=(
  ...
  --override "endpoint_key=scenario1_robust_v6g_deadline_reservation_v6d_dynrule_warm_cap05"
  ...
  --override "solver_enable_prev_day_route_seed=true"
)
