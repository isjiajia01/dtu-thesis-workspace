...
#BSUB -J OOD_ODENSE_D60R[1-5]
#BSUB -q hpc
#BSUB -o logs/scenario1_ood_odense_v6g_v6d_dyn60_relax_cap05_%I.out
#BSUB -e logs/scenario1_ood_odense_v6g_v6d_dyn60_relax_cap05_%I.err
#BSUB -n 1
#BSUB -W 04:00
...
OVERRIDES=(
  ...
  --override "endpoint_key=scenario1_ood_odense_v6g_v6d_dyn60_relax_cap05"
  --override "data_path=data/processed/multiday_benchmark_odense.json"
  --override "matrix_dir=data/processed/vrp_matrix_odense"
  ...
  --override "solver_max_no_improve_chunks=2"
  --override "solver_continue_improvement_ratio=0.0010"
