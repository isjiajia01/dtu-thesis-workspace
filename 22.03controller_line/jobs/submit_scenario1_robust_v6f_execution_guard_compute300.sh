...
#BSUB -J SCENARIO1_RobustV6FExec_T300[1-10]
#BSUB -q hpc
#BSUB -o logs/scenario1_robust_v6f_execution_guard_compute300_%I.out
#BSUB -e logs/scenario1_robust_v6f_execution_guard_compute300_%I.err
#BSUB -n 1
#BSUB -W 04:00
...
OVERRIDES=(
  --override "endpoint_key=scenario1_robust_v6f_execution_guard_compute300"
