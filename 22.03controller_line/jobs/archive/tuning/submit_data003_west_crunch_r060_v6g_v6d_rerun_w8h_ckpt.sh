...
#BSUB -J DATA003_WEST_R060_V6G300R2[1-10]
#BSUB -q hpc
#BSUB -o logs/data003_west_r060_v6g300_r2_%I.out
#BSUB -e logs/data003_west_r060_v6g300_r2_%I.err
#BSUB -n 1
#BSUB -W 08:00
...
OVERRIDES=(
  --override "endpoint_key=data003_west_crunch_r060_v6g_v6d_compute300_r2"
