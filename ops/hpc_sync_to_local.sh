...
# Default back-sync keeps the iCloud workspace light and source-focused.
# Pull large HPC outputs separately into ~/thesis-local-state/dtu-sem6/hpc-pulls when needed.
