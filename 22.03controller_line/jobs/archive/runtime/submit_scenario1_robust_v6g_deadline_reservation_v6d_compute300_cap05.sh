...
# Herlev v6g_v6d compute300 candidate-cap variant: cap05.

#BSUB -J SCENARIO1_RobustV6GReserve_V6D_T300_CAP05[1-10]
#BSUB -q hpc
#BSUB -o logs/scenario1_robust_v6g_deadline_reservation_v6d_compute300_cap05_%I.out
#BSUB -e logs/scenario1_robust_v6g_deadline_reservation_v6d_compute300_cap05_%I.err
#BSUB -n 1
#BSUB -W 06:00
...
OVERRIDES=(
  ...
  --override "endpoint_key=scenario1_robust_v6g_deadline_reservation_v6d_compute300_cap05"
