...
#BSUB -J SCENARIO1_RobustV6HBoost_V6D_T300[1-10]
#BSUB -q hpc
#BSUB -o logs/scenario1_robust_v6h_deadline_boost_v6d_compute300_%I.out
#BSUB -e logs/scenario1_robust_v6h_deadline_boost_v6d_compute300_%I.err
#BSUB -n 1
#BSUB -W 04:00
...
OVERRIDES=(
  --override "endpoint_key=scenario1_robust_v6h_deadline_boost_v6d_compute300"
  --override "use_robust_controller=true"
  --override "robust_horizon_days=3"
  --override "robust_controller_version=v6h_deadline_boost_value_rerank"
