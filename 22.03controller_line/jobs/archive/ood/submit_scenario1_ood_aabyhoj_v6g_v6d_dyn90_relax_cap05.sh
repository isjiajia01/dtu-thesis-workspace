...
#BSUB -J OOD_AABYHOJ_D90R[1-5]
#BSUB -q hpc
#BSUB -o logs/scenario1_ood_aabyhoj_v6g_v6d_dyn90_relax_cap05_%I.out
#BSUB -e logs/scenario1_ood_aabyhoj_v6g_v6d_dyn90_relax_cap05_%I.err
#BSUB -n 1
#BSUB -W 04:00
...
OVERRIDES=(
  ...
  --override "endpoint_key=scenario1_ood_aabyhoj_v6g_v6d_dyn90_relax_cap05"
