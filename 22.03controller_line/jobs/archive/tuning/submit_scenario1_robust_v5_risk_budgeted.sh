...
#BSUB -J SCENARIO1_RobustV5Risk[1-10]
#BSUB -q hpc
#BSUB -o logs/scenario1_robust_v5_risk_budgeted_%I.out
#BSUB -e logs/scenario1_robust_v5_risk_budgeted_%I.err
#BSUB -n 1
#BSUB -W 02:00
...
OVERRIDES=(
  --override "endpoint_key=scenario1_robust_v5_risk_budgeted"
