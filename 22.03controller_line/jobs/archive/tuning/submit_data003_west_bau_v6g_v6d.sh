...
#BSUB -J DATA003_WEST_BAU_V6G300[1-10]
#BSUB -q hpc
#BSUB -o logs/data003_west_bau_v6g300_%I.out
#BSUB -e logs/data003_west_bau_v6g300_%I.err
#BSUB -n 1
#BSUB -W 08:00
...
OVERRIDES=(
  --override "endpoint_key=data003_west_bau_v6g_v6d_compute300"
