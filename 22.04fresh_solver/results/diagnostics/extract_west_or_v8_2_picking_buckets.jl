...
function main()
    ...
    out_csv = joinpath(thesis_root, "results", "diagnostics", "west_or_v8_2_picking_buckets.csv")
    out_json = joinpath(thesis_root, "results", "diagnostics", "west_or_v8_2_picking_summary.json")
