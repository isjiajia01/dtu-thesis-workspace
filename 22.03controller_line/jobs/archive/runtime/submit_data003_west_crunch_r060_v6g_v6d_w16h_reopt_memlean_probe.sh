...
#BSUB -J DATA003_WEST_R060_V6G300MEMPROBE
#BSUB -q hpc
#BSUB -o logs/data003_west_r060_v6g300_w16h_reopt_memlean_probe.out
#BSUB -e logs/data003_west_r060_v6g300_w16h_reopt_memlean_probe.err
#BSUB -n 1
#BSUB -W 04:00
...
OVERRIDES=(
  --override "endpoint_key=data003_west_crunch_r060_v6g_v6d_compute300_w16h_reopt_memlean_probe"
