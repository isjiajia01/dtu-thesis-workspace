...
#BSUB -J DATA003_WEST_R060_V6G90RRPT12[1-10]
#BSUB -q hpc
#BSUB -o logs/data003_west_r060_v6g90r_w12h_reopt_%I.out
#BSUB -e logs/data003_west_r060_v6g90r_w12h_reopt_%I.err
#BSUB -n 1
#BSUB -W 12:00
...
OVERRIDES=(
  --override "endpoint_key=data003_west_r060_v6g90r_w12h_reopt"
