...
#BSUB -J SC1_V6G_CAP05_REOPT[1-10]
#BSUB -q hpc
#BSUB -o logs/scenario1_robust_v6g_deadline_reservation_v6d_compute300_cap05_reopt_%I.out
#BSUB -e logs/scenario1_robust_v6g_deadline_reservation_v6d_compute300_cap05_reopt_%I.err
#BSUB -n 1
#BSUB -W 06:00
