...
#BSUB -J OOD_AALBORG_V6G_V6D_T300[1-10]
#BSUB -q hpc
#BSUB -o logs/scenario1_ood_aalborg_v6g_v6d_compute300_%I.out
#BSUB -e logs/scenario1_ood_aalborg_v6g_v6d_compute300_%I.err
#BSUB -n 1
#BSUB -W 04:00
...
OVERRIDES=(
  --override "endpoint_key=scenario1_ood_aalborg_v6g_v6d_compute300"
