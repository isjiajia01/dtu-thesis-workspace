...
#BSUB -J DATA003_WEST_R060_V6GAUTO[1-10]
#BSUB -q hpc
#BSUB -o logs/data003_west_r060_v6g_automode_%I.out
#BSUB -e logs/data003_west_r060_v6g_automode_%I.err
#BSUB -n 1
#BSUB -W 12:00
...
OVERRIDES=(
  --override "endpoint_key=data003_west_crunch_r060_v6g_v6d_automode"
