...
#BSUB -J SCENARIO1_RobustV5Risk_T300[1-10]
#BSUB -q hpc
#BSUB -o logs/scenario1_robust_v5_risk_budgeted_compute300_%I.out
#BSUB -e logs/scenario1_robust_v5_risk_budgeted_compute300_%I.err
#BSUB -n 1
#BSUB -W 04:00
...
OVERRIDES=(
  --override "endpoint_key=scenario1_robust_v5_risk_budgeted_compute300"
  --override "use_robust_controller=true"
  --override "robust_horizon_days=3"
  --override "robust_controller_version=v5_risk_budgeted_commitment"
