...
function build_or_v8_config()
    return FreshSolver.SolverConfig(
        controller=FreshSolver.ControllerConfig(
            ...
            controller_shadow_price_weight=0.55,
        ...
        routing=FreshSolver.RoutingConfig(
            ...
            shadow_price_weight=0.20,
            normalized_shadow_price=true,
            regime_aware_normalization=true,
            dynamic_shadow_price_v8=true,
            shadow_price_activation_utilization=0.80,
            shadow_price_convex_gamma=2.0,
            shadow_price_peak_eta=3.0,
            alpha_gate=0.7,
            alpha_picking=1.8,
            alpha_staging=0.5,
            beta_gate=1.0,
            ...
            service_shield_relief_weight=1.4,
        ),
...
function main()
    ...
    out_csv = joinpath(thesis_root, "results", "diagnostics", "west_or_v8_picking_buckets.csv")
    out_json = joinpath(thesis_root, "results", "diagnostics", "west_or_v8_picking_summary.json")

    config = build_or_v8_config()
