...
files = {
    ...
    'v8_2': root / 'west_or_v8_2_picking_buckets.csv',
}
...
out_csv = root / 'west_v7_v8_v8_1_v8_2_picking_curve_compare.csv'
out_json = root / 'west_v7_v8_v8_1_v8_2_picking_curve_compare.json'
with out_csv.open('w') as f:
    f.write('bucket_hhmm,v7_total_picking_over,v8_total_picking_over,v8_1_total_picking_over,v8_2_total_picking_over\n')
    for b in all_buckets:
        f.write(f"{b},{agg['v7'].get(b,0.0)},{agg['v8'].get(b,0.0)},{agg['v8_1'].get(b,0.0)},{agg['v8_2'].get(b,0.0)}\n")
with out_json.open('w') as f:
    json.dump({'top_peaks': peaks}, f, indent=2)
print(out_csv)
print(out_json)
