...
#BSUB -J OOD_AALBORG_CTRL[1-5]
#BSUB -q hpc
#BSUB -o logs/scenario1_ood_aalborg_v6g_v6d_ctrl300_cap05_%I.out
#BSUB -e logs/scenario1_ood_aalborg_v6g_v6d_ctrl300_cap05_%I.err
#BSUB -n 1
#BSUB -W 04:00
...
OVERRIDES=(
  ...
  --override "endpoint_key=scenario1_ood_aalborg_v6g_v6d_ctrl300_cap05"
