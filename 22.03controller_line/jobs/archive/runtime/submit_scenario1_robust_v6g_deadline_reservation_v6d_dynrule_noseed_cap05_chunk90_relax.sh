...
#BSUB -J SC1_V6G_CAP05_DYN90R[1-10]
#BSUB -q hpc
#BSUB -o logs/scenario1_robust_v6g_deadline_reservation_v6d_dynrule_noseed_cap05_chunk90_relax_%I.out
#BSUB -e logs/scenario1_robust_v6g_deadline_reservation_v6d_dynrule_noseed_cap05_chunk90_relax_%I.err
#BSUB -n 1
#BSUB -W 06:00
...
OVERRIDES=(
  ...
  --override "endpoint_key=scenario1_robust_v6g_deadline_reservation_v6d_dynrule_noseed_cap05_chunk90_relax"
