...
#BSUB -J DATA003_EAST_R060_V6GDYN90[1-10]
#BSUB -q hpc
#BSUB -o logs/data003_east_crunch_r060_v6g_v6d_w12h_dyn90_reopt_%I.out
#BSUB -e logs/data003_east_crunch_r060_v6g_v6d_w12h_dyn90_reopt_%I.err
#BSUB -n 1
#BSUB -W 12:00
...
OVERRIDES=(
  --override "endpoint_key=data003_east_crunch_r060_v6g_v6d_compute300_w12h_dyn90_reopt"
